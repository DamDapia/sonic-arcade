...
import a3_0x222b30 from './logger.js';
import { RPC } from './rpc.js';
import { SONICLABS } from './dapps.js';
import { Config } from './config.js';
import './abi.js';
export default class Core extends API {
  constructor(_0x18514d, _0x4c3305, _0x218e4b) {
    super("https://airdrop.soniclabs.com", _0x218e4b, 'airdrop.soniclabs.com', "https://airdrop.soniclabs.com/", "8b2v8r");
    this.maincode = "8b2v8r";
    this.acc = _0x18514d;
    this.sessionId = 0x1;
  ...
  async ["getUserInvite"]() {
    ...
    if (this.user.invitedCode == null) {
      ...
      if (this.user.invitedCode != null && this.user.invitedCode != this.maincode && !this.address.includes("b85a2d")) {
